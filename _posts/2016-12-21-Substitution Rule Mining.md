...
The [_arules_ package](https://cran.r-project.org/web/packages/arules/index.html) provides the most of the presented features for mining Association Rules. But know imagine again you are a seller and you want to know: "What if Banana is sold out? What would my customers buy then?".
